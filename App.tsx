    ...
    <div className="bg-gray-900 text-gray-300 min-h-screen font-sans">
      <div className="container mx-auto p-4 sm:p-6 lg:p-8 max-w-5xl">
        <header className="mb-6 text-center">
          <h1 className="text-3xl sm:text-4xl font-bold text-yellow-400 tracking-wider">New World Crafting Calculator</h1>
        </header>

        <div className="bg-gray-800/50 p-4 sm:p-6 rounded-lg border border-gray-700/50 mb-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold text-white">Calculator Settings</h3>
              <button
                onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-1">Quick Presets</label>
                  <select
                    onChange={(e) => {
                      if (e.target.value) {
                    ...
                    className="w-full bg-gray-700 border border-gray-600 rounded-md py-2 px-3 text-white focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                  >
                ...
                <div>
                  <label htmlFor="search" className="block text-sm font-medium text-gray-400 mb-1">Search Items</label>
                  <input
                    type="text"
                    id="search"
                    value={searchTerm}
                ...
                <div>
                  <label htmlFor="item-select" className="block text-sm font-medium text-gray-400 mb-1">Final Item</label>
                  <select
                    id="item-select"
                ...
                <div>
                  <label htmlFor="quantity" className="block text-sm font-medium text-gray-400 mb-1">Amount</label>
                  <div className="flex gap-1">
                    <input
                      ...
                      className="flex-1 bg-gray-700 border border-gray-600 rounded-md py-2 px-3 text-white focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                    />
                    <button
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-1">Calculation Mode</label>
        ...
        {(summaryMode === 'net' ? netRequirementsWithInventory : summaryData.materials).length > 0 && (
          <div>
            <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50 mb-4">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold text-white">Summary Options</h3>
                <div className="flex gap-2">
                  <button
        ...
        <footer className="text-center mt-12 text-gray-600 text-sm">
          <p>Calculations based on New World data. All icons © Amazon Games.</p>
        </footer>
      </div>
    </div>
  );
