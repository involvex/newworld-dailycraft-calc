...
const ContextMenu: React.FC<ContextMenuProps> = ({ x, y, onClose, onExpand, onCollapse, onRemove }) => {
  return (
    ...
    >
      <ul className="py-1">
        <li onClick={onExpand} className="px-4 py-2 text-sm text-yellow-100 hover:bg-gray-700 cursor-pointer">Expand</li>
        <li onClick={onCollapse} className="px-4 py-2 text-sm text-yellow-100 hover:bg-gray-700 cursor-pointer">Collapse</li>
