    ...
    callback({
      responseHeaders: {
        ...
        'Content-Security-Policy': [
          ...
          "script-src 'self' 'unsafe-inline' 'unsafe-eval' data: file: https://cdn.tailwindcss.com https://esm.sh https://unpkg.com https://cdn.jsdelivr.net https://api.allorigins.win https://gaming.tools; " +
