...
export function collectPathToNode(rootNode: any, targetNodeId: string): string[] {
  const path: string[] = [];
...
export function collectAncestorNodeIds(rootNode: any, targetNodeId: string): string[] {
